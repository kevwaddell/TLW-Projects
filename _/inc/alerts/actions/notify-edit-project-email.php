...
$subject = "$from_name has updated a TLW Project";
$message = "<h3><font style=\"color: red;\">$from_name</font> has made changes to <font style=\"color: red;\">". $project->post_title ."</font> project.</h3>";
$message .= "<br>";
...
$message .= "<tr><td bgcolor=\"#C0C0C0\">Project created by:</td><td bgcolor=\"#D8D8D8\">". $project_created_by->data->display_name ."</td></tr>";
